...
let prodTitle = document.querySelector('#Detail-Text > ul > .title');
let descPrice = document.querySelector('#Detail-Text > ul > .dis_price');
...
function addView() {
    ...
    //상품정보 출력
    addTitle.innerText = prodTitle.innerText;// 타이틀텍스트
